module github.com/mornyx/decode-plan

go 1.24.1

require github.com/pingcap/tidb v1.1.0-beta.0.20221205134003-35819ee43ffd
...
require (
	...
	github.com/pingcap/tidb/parser v0.0.0-20221205134003-35819ee43ffd // indirect
